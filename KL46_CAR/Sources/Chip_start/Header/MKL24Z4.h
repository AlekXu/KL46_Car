...
**
**     Abstract:
**         This header file implements peripheral memory map for MKL24Z4
**         processor.
**
 ...
 * @version 1.4
 * @date 2013-04-05
 * @brief Peripheral memory map for MKL24Z4
 *
 * This header file implements peripheral memory map for MKL24Z4 processor.
 */
...
#if !defined(MCU_MKL24Z4)  /* Check if memory map has not been already included */
#define MCU_MKL24Z4
